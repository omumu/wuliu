				...
				<tr>
					...
					<td>
						<button type="button" class="btn btn-default" title="物流信息"
							...
							货物名：<%out.print(map.get("GoodsName"));%>
							货物号：<%out.print(map.get("GoodsNumber"));%>
							货物类型：<%out.print(map.get("GoodsStyle"));%>
							时间：<%out.print(map.get("GissueDate"));%>
							">
							查看</button>
					</td>
				</tr>
